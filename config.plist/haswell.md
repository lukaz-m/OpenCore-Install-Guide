...
* **All properties must be defined**, there are no default OpenCore to fall back on so **do not delete sections unless told explicitly so**. If the guide doesn't mention the option, leave it at default.
